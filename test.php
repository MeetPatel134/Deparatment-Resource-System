...
<head>
    ...
    <title>Welocme To Book Buddy</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="myNavBar">
        <a class="navbar-brand logo" href="test.php">Book Buddy</a>
        ...
        <div class="container-fluid secondBox">
             <div class="row">
                <div class="col bestSellTitleDiv">
                    <h5 class="bestSellTitle">Featuring Books</h5>
    ...
    <div class="row justify-content-center">
                    <div class="col-auto">
                    <a style="padding-top: 20px"href="./php/recommendations.php" class="btn btn-dark exploreBtn">Explore Recommendations</a>
                    </div>
                </div>
</div>
    ...
    <footer class="text-center myFooter">
        <div class="text-center">
            <P class="ourMessage">© 2020 Copyright: Book Buddy</P>
        </div>
    </footer>
